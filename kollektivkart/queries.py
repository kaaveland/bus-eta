...
SELECT 
  ...
  round(hourly_quartile / monthly_duration, 1) as rush_intensity,
  hourly_quartile :: int4 as hourly_quartile,
  hourly_duration :: int4 as hourly_duration,
  monthly_duration :: int4 as monthly_duration,
  monthly_delay :: int4 as monthly_delay,
  hourly_delay :: int4 as hourly_delay,
  monthly_deviation :: int4 as monthly_deviation,
  hourly_deviation :: int4 as hourly_deviation,
  monthly_count,
  hourly_count  
